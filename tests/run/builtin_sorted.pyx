...
@cython0.test_assert_path_exists("//GeneralCallNode")
...
@cython0.test_fail_if_path_exists("//YieldExprNode",
                                 "//NoneCheckNode")
@cython0.test_assert_path_exists("//InlinedGeneratorExpressionNode")
def sorted_genexp():
    """
    >>> sorted_genexp()
...
@cython0.test_fail_if_path_exists("//SimpleCallNode//SimpleCallNode")
@cython0.test_assert_path_exists("//SimpleCallNode/NameNode[@name = 'range']")
