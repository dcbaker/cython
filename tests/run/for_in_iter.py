...
@cython0.test_assert_path_exists('//TupleNode//IntNode')
@cython0.test_fail_if_path_exists('//ListNode//IntNode')
...
@cython0.test_assert_path_exists('//ReturnStatNode//ForInStatNode//TupleNode')
@cython0.test_fail_if_path_exists('//ReturnStatNode//ForInStatNode//ListNode')
