...
def test_outer_inner_double_int():
    ...
    def inner():
        ...
        y = 2.0
    inner()
    return cython0.typeof(x), cython0.typeof(y)
...
def test_outer_inner_ptr():
    ...
    def inner():
        ...
        x = 1
        xptr_inner = &x
        assert cython0.typeof(xptr_inner) == cython0.typeof(xptr_outer), (
            '%s != %s' % (cython0.typeof(xptr_inner), cython0.typeof(xptr_outer)))
    inner()
    return cython0.typeof(xptr_outer)
