...
cdef class cclass:
    ...
    def test2(cls, arg1, arg2):
        ...
        ('type object', 1, 2)
        """
        return cython0.typeof(cls), arg1, arg2
    ...
    def test1_args(cls, *args):
        ...
        ('type object', (1, 2, 3))
        """
        return cython0.typeof(cls), args
    ...
    def test2_args(cls, arg, *args):
        ...
        ('type object', 1, (2, 3))
        """
        return cython0.typeof(cls), arg, args
    ...
    def test1_args_kwargs(cls, *args, **kwargs):
        ...
        ('type object', (1, 2, 3), {})
        """
        return cython0.typeof(cls), args, kwargs
    ...
    def test2_args_kwargs(cls, arg, *args, **kwargs):
        ...
        ('type object', 1, (2, 3), {})
        """
        return cython0.typeof(cls), arg, args, kwargs
