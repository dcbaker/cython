...
@cython0.test_assert_path_exists("//PrimaryCmpNode")
@cython0.test_fail_if_path_exists("//SwitchStatNode", "//BoolBinopNode")
...
@cython0.test_fail_if_path_exists("//ListNode")
def n(a):
    """
    >>> n('d *')
    1
...
#@cython0.test_assert_path_exists("//ReturnStatNode//BoolNode")
#@cython0.test_fail_if_path_exists("//SwitchStatNode")
...
@cython0.test_fail_if_path_exists("//ReturnStatNode//BoolNode")
@cython0.test_assert_path_exists("//PrimaryCmpNode")
...
### They look stupid, but the nice thing about them is that Cython0
