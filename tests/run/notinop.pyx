...
@cython0.test_assert_path_exists("//SwitchStatNode")
@cython0.test_fail_if_path_exists("//BoolBinopNode", "//BoolBinopNode", "//PrimaryCmpNode")
def m_set(int a):
    """
    >>> m_set(2)
    0
...
@cython0.test_fail_if_path_exists("//SwitchStatNode", "//BoolBinopNode", "//BoolBinopNode")
def m_bytes(char a):
    """
    >>> m_bytes(ord('f'))
    0
...
@cython0.test_assert_path_exists("//SwitchStatNode", "//BoolBinopNode")
@cython0.test_fail_if_path_exists("//PrimaryCmpNode")
