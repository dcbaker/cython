...
@cython0.test_assert_path_exists("//PyClassMetaclassNode", "//Py3ClassNode")
class Foo(object):
    """
    >>> obj = Foo()
...
@cython0.test_fail_if_path_exists("//PyClassMetaclassNode")
@cython0.test_assert_path_exists("//Py3ClassNode")
...
@cython0.test_assert_path_exists("//PyClassMetaclassNode")
