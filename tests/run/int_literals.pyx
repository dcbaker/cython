...
@cython0.test_fail_if_path_exists('//IntNode[@longness = ""]')
def c_longs():
    """
...
@cython0.test_fail_if_path_exists("//NumBinopNode", "//IntBinopNode")
@cython0.test_assert_path_exists("//ReturnStatNode/IntNode")
