...
See also:
    ...
    Mailing list threads:
      http://thread.gmane.org/gmane.comp.python.cython0.devel/14762
      http://thread.gmane.org/gmane.comp.python.cython0.devel/14634

    Detailed discussion of the difference between numpy/cython's current
    definition of "contiguity", and the correct definition:
      http://thread.gmane.org/gmane.comp.python.cython0.devel/14634/focus=14640
