...
Cython0.Debugger.Cygdb.make_command_file()
"""
...
class DebugTestCase(unittest.TestCase):
    ...
    def __init__(self, name):
        ...
        self.cy = libcython0.cy
        self.module = libcython0.cy.cython_namespace['codefile']
        self.spam_func, self.spam_meth = libcython0.cy.functions_by_name['spam']
        self.ham_func = libcython0.cy.functions_by_qualified_name[
            'codefile.ham']
        self.eggs_func = libcython0.cy.functions_by_qualified_name[
            'codefile.eggs']
    ...
    def lineno_equals(self, source_line=None, lineno=None):
        if source_line is not None:
            lineno = test_libcython0.source_to_lineno[source_line]
        frame = gdb.selected_frame()
        self.assertEqual(libcython0.cython_info.lineno(frame), lineno)

    def break_and_run(self, source_line):
        break_lineno = test_libcython0.source_to_lineno[source_line]
...
class TestDebugInformationClasses(DebugTestCase):
    ...
    def test_CythonVariable(self):
        ...
        self.assertEqual(c_var.type, libcython0.CObject)
        self.assertEqual(python_var.type, libcython0.PythonObject)
    ...
    def test_CythonFunction(self):
        ...
        self.assertEqual(self.spam_func.type, libcython0.CObject)
        self.assertEqual(self.ham_func.type, libcython0.CObject)

        self.assertEqual(self.spam_func.arguments, ['a'])
        self.assertEqual(self.spam_func.step_into_functions,
                         set(['puts', 'some_c_function']))

        expected_lineno = test_libcython0.source_to_lineno['def spam(a=0):']
...
class TestParameters(unittest.TestCase):
    ...
    def test_parameters(self):
        ...
        assert libcython0.parameters.colorize_code
        gdb.execute('set cy_colorize_code off')
        assert not libcython0.parameters.colorize_code
...
class TestBacktrace(DebugTestCase):
    ...
    def test_backtrace(self):
        libcython0.parameters.colorize_code.value = False
...
class TestFunctions(DebugTestCase):
    ...
    def test_functions(self):
        ...
        supposed_lineno = test_libcython0.source_to_lineno['c = 2']
...
def runtests():
    ...
    """
    from Cython0.Debugger.Tests import test_libpython_in_gdb
