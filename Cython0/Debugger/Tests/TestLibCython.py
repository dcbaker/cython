...
import runtests
import Cython0.Distutils.extension
import Cython0.Distutils.old_build_ext as build_ext
from Cython0.Debugger import Cygdb as cygdb
...
class DebuggerTestCase(unittest.TestCase):
    ...
    def setUp(self):
        ...
        try:
            ...
            # ext = Cython0.Distutils.extension.Extension(
                # 'codefile',
                # ['codefile.pyx'],
                # cython_gdb=True,
            ...
            # distutils.core.setup(
                ...
                # ext_modules=[ext],
                # cmdclass=dict(build_ext=Cython0.Distutils.build_ext)
            # )
...
class GdbDebuggerTestCase(DebuggerTestCase):
    ...
    def setUp(self):
        ...
        code = textwrap.dedent('''\
            ...
            from Cython0.Debugger.Tests import test_libcython_in_gdb
        ...
        paths.append(os.path.dirname(os.path.dirname(
            os.path.abspath(Cython0.__file__))))
