"""Cython0.Distutils.old_build_ext
...
if (not _check_stack('setuptools/extensions.py')
    ...
    warnings.warn(
        "Cython0.Distutils.old_build_ext does not properly handle dependencies "
        "and is deprecated.")
...
class old_build_ext(_build_ext.build_ext):
    ...
    def cython_sources(self, sources, extension):
        ...
        """
        try:
            from Cython0.Compiler.Main \
                import CompilationOptions, \
                       default_options as cython_default_options, \
                       compile as cython_compile
            from Cython0.Compiler.Errors import PyrexError
        except ImportError:
            e = sys.exc_info()[1]
        ...
        # Cython0.Distutils.extension.Extension is used, otherwise just
        ...
        #        cython_include_dirs (if Cython0.Distutils.extension is used).
        ...
        #         cython_directives (if Cython0.Distutils.extension is used).
