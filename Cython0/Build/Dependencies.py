...
@cython0.locals(start=cython0.Py_ssize_t, end=cython0.Py_ssize_t)
...
@cython0.locals(start=cython0.Py_ssize_t, q=cython0.Py_ssize_t,
               single_q=cython0.Py_ssize_t, double_q=cython0.Py_ssize_t,
               hash_mark=cython0.Py_ssize_t, end=cython0.Py_ssize_t,
               k=cython0.Py_ssize_t, counter=cython0.Py_ssize_t, quote_len=cython0.Py_ssize_t)
...
class DependencyTree(object):
    ...
    def cimported_files(self, filename):
        ...
        for module in self.cimports(filename):
            if module[:7] == 'cython0.' or module == 'cython0':
                continue
            ...
            if cython_sources:
                ...
                if len(cython_sources) > 1:
                    print("Warning: Multiple cython sources found for extension '%s': %s\n"
                          "See http://cython0.readthedocs.io/en/latest/src/userguide/sharing_declarations.html "
