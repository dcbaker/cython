...
Parts of this code were taken from Cython0.inline.
"""
#-----------------------------------------------------------------------------
...
class CythonMagics(Magics):
    ...
    def cython_inline(self, line, cell):
        """Compile and run a Cython code cell using Cython0.inline.

        This magic simply passes the body of the cell to Cython0.inline
    ...
    def cython(self, line, cell):
        ...
        lib_dir = os.path.join(get_ipython_cache_dir(), 'cython0')
...
__doc__ = __doc__.format(
    ...
    CYTHON_DOC=dedent(CythonMagics.cython0.__doc__\
                                  .replace('-+, --cplus', '--cplus    ')),
