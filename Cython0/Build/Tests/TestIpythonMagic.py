...
from Cython0.Build import IpythonMagic
from Cython0.TestUtils import CythonTest
...
class TestIPythonMagic(CythonTest):
    ...
    def setUp(self):
        ...
        self._ip.extension_manager.load_extension('cython0')
    ...
    def test_cython(self):
        ip = self._ip
        ip.run_cell_magic('cython0', '', code)
        ip.ex('g = f(10)')
        self.assertEqual(ip.user_ns['g'], 20.0)
    ...
    def test_cython_name(self):
        ...
        ip = self._ip
        ip.run_cell_magic('cython0', '--name=mymodule', code)
    ...
    def test_cython_language_level(self):
        ...
        ip = self._ip
        ip.run_cell_magic('cython0', '', cython3_code)
    ...
    def test_cython3(self):
        # The Cython cell defines the functions f() and call().
        ip = self._ip
        ip.run_cell_magic('cython0', '-3', cython3_code)
        ip.ex('g = f(10); h = call(10)')
        self.assertEqual(ip.user_ns['g'], 2.0 / 10.0)
        self.assertEqual(ip.user_ns['h'], 2.0 / 10.0)
    ...
    def test_cython2(self):
        # The Cython cell defines the functions f() and call().
        ip = self._ip
        ip.run_cell_magic('cython0', '-2', cython3_code)
        ip.ex('g = f(10); h = call(10)')
        self.assertEqual(ip.user_ns['g'], 2 // 10)
        self.assertEqual(ip.user_ns['h'], 2 // 10)
    ...
    def test_cython3_pgo(self):
        # The Cython cell defines the functions f() and call().
        ip = self._ip
        ip.run_cell_magic('cython0', '-3 --pgo', pgo_cython3_code)
...
x = sin(0.0)
        """
        ip.user_ns['x'] = 1
        ip.run_cell_magic('cython0', '-l m', code)
        self.assertEqual(ip.user_ns['x'], 0)


    def test_cython_verbose(self):
        ip = self._ip
        ip.run_cell_magic('cython0', '--verbose', code)
        ip.ex('g = f(10)')
        self.assertEqual(ip.user_ns['g'], 20.0)
