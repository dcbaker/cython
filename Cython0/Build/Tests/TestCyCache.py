...
import Cython0.Build.Dependencies
import Cython0.Utils
...
class TestCyCache(CythonTest):
    ...
    def fresh_cythonize(self, *args, **kwargs):
        Cython0.Utils.clear_function_caches()
        Cython0.Build.Dependencies._dep_tree = None  # discard method caches
        Cython0.Build.Dependencies.cythonize(*args, **kwargs)
