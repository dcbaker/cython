...
# This utility provides cython0.array and cython0.view.memoryview
...
cdef class array:
    ...
    def __cinit__(array self, tuple shape, Py_ssize_t itemsize, format not None,
        ...
        if not self.ndim:
            raise ValueError("Empty shape tuple for cython0.array")

        if itemsize <= 0:
            raise ValueError("itemsize <= 0 for cython0.array")
...
#
### Memoryview constants and cython0.view.memoryview class
#
