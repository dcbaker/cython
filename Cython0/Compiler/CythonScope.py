...
class CythonScope(ModuleScope):
    ...
    def __init__(self, context):
        ModuleScope.__init__(self, u'cython0', None, None)
    ...
    def find_module(self, module_name, pos):
        error("cython0.%s is not available" % module_name, pos)
    ...
    def find_submodule(self, module_name):
        ...
        if entry and entry.as_module:
            ...
            raise error((StringSourceDescriptor(u"cython", u""), 0, 0),
                  "cython0.%s is not available" % module_name)
    ...
    def load_cythonscope(self):
        ...
        cython0.array() and for cython0.view.*.
        """
