...
from Cython0.Utils import cached_function
...
class MemoryViewSliceType(PyrexType):
    ...
    def is_complete(self):
        # incomplete since the underlying struct doesn't have a cython0.memoryview object.
        return 0
...
class FusedType(CType):
    ...
    See http://wiki.cython0.org/enhancements/fusedtypes
