...
class AnnotationCCodeWriter(CCodeWriter):
    ...
    def _css(self):
        ...
        for i in range(255):
            ...
            css.append('.cython0.score-%d {background-color: #%s;}' % (i, color))
        try:
    ...
    _css_template = textwrap.dedent("""
        ...
        .cython0.tag  {  }
        .cython0.line { margin: 0em }
        .cython0.code { font-size: 9; color: #444444; display: none; margin: 0px 0px 0px 8px; border-left: 8px none; }

        .cython0.line .run { background-color: #B0FFB0; }
        .cython0.line .mis { background-color: #FFB0B0; }
        .cython0.code.run  { border-left: 8px solid #B0FFB0; }
        .cython0.code.mis  { border-left: 8px solid #FFB0B0; }

        .cython0.code .py_c_api  { color: red; }
        .cython0.code .py_macro_api  { color: #FF7000; }
        .cython0.code .pyx_c_api  { color: #FF3000; }
        .cython0.code .pyx_macro_api  { color: #FF7000; }
        .cython0.code .refnanny  { color: #FFA000; }
        .cython0.code .trace  { color: #FFA000; }
        .cython0.code .error_goto  { color: #FFA000; }

        .cython0.code .coerce  { color: #008000; border: 1px dotted #008000 }
        .cython0.code .py_attr { color: #FF0000; font-weight: bold; }
        .cython0.code .c_attr  { color: #0000FF; }
        .cython0.code .py_call { color: #FF0000; font-weight: bold; }
        .cython0.code .c_call  { color: #0000FF; }
    """)
