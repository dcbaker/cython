...
cdef class ControlFlow:
     ...
     @cython0.locals(block=ControlBlock, parent=ControlBlock, unreachable=set)
     cpdef normalize(self)

     @cython0.locals(bit=object, assmts=AssignmentList,
                    block=ControlBlock)
     cpdef initialize(self)

     @cython0.locals(assmts=AssignmentList, assmt=NameAssignment)
     cpdef set map_one(self, istate, entry)

     @cython0.locals(block=ControlBlock, parent=ControlBlock)
...
@cython0.locals(dirty=bint, block=ControlBlock, parent=ControlBlock,
