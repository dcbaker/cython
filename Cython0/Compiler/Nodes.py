...
import cython0
cython0.declare(sys=object, os=object, copy=object,
...
def analyse_type_annotation(annotation, env, assigned_value=None):
    ...
    if annotation.is_dict_literal:
        warning(annotation.pos,
                "Dicts should no longer be used as type annotations. Use 'cython0.int' etc. directly.")
    ...
    if annotation.is_name and not annotation.cython_attribute and annotation.name in ('int', 'long', 'float'):
        ...
        if assigned_value is not None and arg_type is not None and not arg_type.is_pyobject:
            ...
            if assigned_type and assigned_type.is_pyobject:
                ...
                is_ambiguous = True
                arg_type = None
        # ignore 'int' and require 'cython0.int' to avoid unsafe integer declarations
        ...
        warning(annotation.pos,
                "Strings should no longer be used for type declarations. Use 'cython0.int' etc. directly.")
...
class FusedTypeNode(CBaseTypeNode):
    ...
    Represents a fused type in a ctypedef statement:
        ...
        ctypedef cython0.fused_type(int, long, long long) integral
...
class CVarDefNode(StatNode):
    ...
    #  decorators    [cython0.locals(...)] or None
    #  directive_locals { string : NameNode } locals defined by cython0.locals(...)
...
class FuncDefNode(StatNode, BlockNode):
    ...
    #  directive_locals { string : ExprNode } locals defined by cython0.locals(...)
    #  directive_returns [ExprNode] type defined by cython0.returns(...)
...
class SingleAssignmentNode(AssignmentNode):
    ...
    def analyse_declarations(self, env):
        ...
        # handle declarations of the form x = cython0.foo()
...
utility_code_for_cimports = {
    ...
    'cython0.view'           : cython_view_utility_code,
}
...
class ParallelNode(Node):
    """
    Base class for cython0.parallel constructs.
    """
...
class ParallelStatNode(StatNode, ParallelNode):
    """
    Base class for 'with cython0.parallel.parallel():' and 'for i in prange():'.
...
class ParallelWithBlockNode(ParallelStatNode):
    """
    This node represents a 'with cython0.parallel.parallel():' block
    """
    ...
    def analyse_declarations(self, env):
        ...
        if self.args:
            error(self.pos, "cython0.parallel.parallel() does not take "
...
class ParallelRangeNode(ParallelStatNode):
    """
    This node represents a 'for i in cython0.parallel.prange():' construct.
