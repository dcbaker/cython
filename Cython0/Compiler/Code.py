...
import cython0
cython0.declare(os=object, re=object, operator=object, textwrap=object,
...
def get_utility_dir():
    ...
    # http://trac.cython0.org/cython_trac/ticket/475
...
cython0.declare(possible_unicode_identifier=object, possible_bytes_identifier=object,
...
class CCodeWriter(object):
    ...
    @cython0.locals(create_from='CCodeWriter')
...
class PyxCodeWriter(object):
    ...
    functionality, the Cython0.Compiler.Importer module will have to be used
