...
from Cython0.TestUtils import TransformTest
from Cython0.Compiler.ParseTreeTransforms import *
from Cython0.Compiler.ParseTreeTransforms import _calculate_pickle_checksums
from Cython0.Compiler.Nodes import *
from Cython0.Compiler import Main, Symtab
...
class TestInterpretCompilerDirectives(TransformTest):
    ...
    import_code = u"""
        ...
        cimport cython0.parallel as par
        from cython cimport parallel as par2
        from cython cimport parallel

        from cython0.parallel cimport threadid as tid
        from cython0.parallel cimport threadavailable as tavail
        from cython0.parallel cimport prange
    """

    expected_directives_dict = {
        u'cython0.parallel': u'cython0.parallel',
        u'par': u'cython0.parallel',
        u'par2': u'cython0.parallel',
        u'parallel': u'cython0.parallel',

        u"tid": u"cython0.parallel.threadid",
        u"tavail": u"cython0.parallel.threadavailable",
        u"prange": u"cython0.parallel.prange",
    }
...
if False:
    from Cython0.Debugger import DebugWriter
    from Cython0.Debugger.Tests.TestLibCython import DebuggerTestCase
else:
