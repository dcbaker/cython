# cython0.* namespace for pure mode.
...
def inline(f, *args, **kwds):
    if isinstance(f, basestring):
        ...
        if _cython_inline is None:
            from Cython0.Build.Inline import cython0_inline as _cython_inline
...
def compile(f):
    from Cython0.Build.Inline import RuntimeCompiledFunction
...
import sys
sys.modules['cython0.parallel'] = CythonDotParallel()
del sys
