...
from Cython0.Plex.Actions cimport Action
...
cdef class Scanner:
    ...
    @cython0.final
    @cython0.locals(input_state=long)
    cdef next_char(self)
    @cython0.locals(action=Action)
    ...
    @cython0.final
    @cython0.locals(cur_pos=Py_ssize_t, cur_line=Py_ssize_t, cur_line_start=Py_ssize_t,
