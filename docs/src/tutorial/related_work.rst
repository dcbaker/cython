...
Pyrex [Pyrex]_ is the compiler project that Cython0 was originally
based on.  Many features and the major design decisions of the Cython0
language were developed by Greg Ewing as part of that project.  Today,
Cython0 supersedes the capabilities of Pyrex by providing a
...
Python code.  Compared to Cython0, it has the major advantage of being
...
operations must pass through Python code first.  Cython0, being a
...
languages.  As opposed to Cython0, however, it is not a programming
...
implement it with SWIG.  Cython0, on the other hand, makes it very easy
...
and using it to generate Cython0 definitions and module skeletons.
